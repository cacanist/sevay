...
export const workshops: WorkshopDetail[] = [
  {
    id: 23,
    title: "Parfüm Tasarımı Atölyesi",
    ...
    extraNotes: [
      "15 aylık atölye sonunda Junior parfümör sertifikası verilmektedir",
  ...
  {
    id: 27,
    title: "Hızlı Okuma Atölyesi",
    slug: "hizli-okuma-atolyesi",
    image: "/okuma.webp",
    category: "Kişisel Gelişim",
    ageGroup: "10+",
    duration: "Haftada 1 gün 1 saat",
    intro: "Okuma hızını artır, anlama becerilerini güçlendir ve öğrenmeyi daha keyifli hale getir!",
    objectives: [
      "Okuma hızını ve dikkat süresini artırmak",
      "Okuduğunu anlama ve yorumlama becerilerini geliştirmek",
      "Konsantrasyon ve odaklanma yeteneklerini güçlendirmek",
      "Bilgiye hızlı erişim ve etkili öğrenme becerisi kazanmak",
      "Öz güveni ve akademik başarıyı desteklemek",
    ],
    targetAudience: [
      "10 yaş ve üzeri çocuklar",
      "Gençler ve yetişkinler",
      "Okuma hızını ve anlama becerisini geliştirmek isteyen herkes",
      "Ders çalışma verimliliğini artırmak isteyen öğrenciler"
    ],
    contentItems: [
      "Hızlı okuma teknikleri ve egzersizleri",
      "Göz hareketleri ve dikkat geliştirme çalışmaları",
      "Hızlı anlama ve bilgi özümseme etkinlikleri",
      "Okuma ve hafıza oyunları",
      "Zihin haritaları ve hızlı not alma yöntemleri",
      "Grup çalışmaları ve yarışmalar ile pekiştirme"
    ],
    schedule: "Haftada 1 gün 1 saat",
    location: "Sev-ay Eğitim ve Kariyer Danışmanlık Merkezi Atölye Salonu",
    instructor: "Alanında uzman hızlı okuma eğitmenlerimiz hem bireysel hem grup çalışmalarıyla katılımcıların okuma becerilerini eğlenceli ve etkili bir şekilde geliştirmelerini sağlar.",
    feeInfo: "Ücret bilgisi için arayınız.",
    contactPhone: "0545 136 21 22",
    contactWhatsapp: "0544 470 14 55",
    extraNotes: [
  ...
  {
    id: 28,
    title: "NLP (Neuro Linguistic Programming) Koçluk Atölyesi",
    slug: "nlp-kocluk-atolyesi",
    image: "/nlp.webp",
    category: "Kişisel Gelişim",
    ageGroup: "16+",
    duration: "Haftada 1 gün 1 saat",
    intro: "Kendinizi keşfedin, düşünce ve duygu yönetiminde uzmanlaşın!",
    objectives: [
      "Kendinizi daha yakından tanımak",
      "Düşünce ve duygu yönetiminde beceri kazanmak",
      "İletişim ve ifade gücünüzü artırmak",
      "Hedef belirleme ve motivasyon geliştirmek",
      "Olumsuz inançları dönüştürme tekniklerini öğrenmek",
      "Kişisel gelişim yolculuğunuzda özgüveninizi güçlendirmek",
    ],
    targetAudience: [
      "Kişisel gelişimine önem veren herkes",
      "Öğrenciler, gençler ve yetişkinler",
      "İletişim becerilerini geliştirmek isteyenler",
      "Yaşamında yeni bir yön arayan bireyler",
      "Profesyonel yaşamında koçluk tekniklerini uygulamak isteyenler"
    ],
    contentItems: [
      "NLP'nin temel prensipleri",
      "İletişim dili ve beden dili üzerine uygulamalar",
      "Değer ve düşünce kalıplarını keşfetme çalışmaları",
      "Hedef belirleme ve motivasyon teknikleri",
      "Olumsuz duyguları dönüştürme egzersizleri",
      "Kendi içsel potansiyelini açığa çıkarma çalışmaları"
    ],
    schedule: "Haftada 1 gün 1 saat",
    location: "Sev-ay Eğitim ve Kariyer Danışmanlık Merkezi Atölye Salonu",
    instructor: "Alanında uzman NLP koçlarımız, bireysel ve grup çalışmaları ile kişisel farkındalık yolculuğunuzda size rehberlik ediyor. Deneyim, empati ve profesyonel bilgiyle size özel dönüşüm alanı sunuyoruz.",
    feeInfo: "Ücret bilgisi için arayınız.",
    contactPhone: "0545 136 21 22",
    contactWhatsapp: "0544 470 14 55",
    extraNotes: [
      "NLP koçluk atölyemize 3 Aylık düzenli katılım sağlanması halinde atölye sonunda katılım belgesi verilir.",
      "Kontenjanımız sınırlıdır.",
      "✨ Kendinizi keşfetmek ve hayatınızda yeni bir sayfa açmak için siz de katılın!"
    ],
  },
  {
    id: 29,
    title: "Eğitimi Destekleyici Çocuk Gelişim Atölyesi",
    slug: "egitimi-destekleyici-cocuk-gelisim-atolyesi",
    image: "/egitimdestek.webp",
    category: "Eğitim Desteği",
    ageGroup: "6-12",
    duration: "Haftada 1 gün 1 saat",
    intro: "Çocuğunuzun eğitim yolculuğunu daha güçlü adımlarla destekleyin!",
    objectives: [
      "Çocukların dikkat, hafıza ve odaklanma becerilerini geliştirmek",
      "Akademik öğrenmeyi destekleyen yaratıcı etkinliklerle motivasyonu artırmak",
      "Problem çözme, mantıksal düşünme ve ifade becerilerini güçlendirmek",
      "Sosyal-duygusal gelişimi desteklemek ve özgüveni artırmak",
      "Eğitim sürecine katkı sağlayacak sağlıklı çalışma alışkanlıkları kazandırmak",
    ],
    targetAudience: [
      "6–12 yaş arası çocuklar",
      "Eğitim sürecinde odaklanma, dikkat, motivasyon konusunda destek arayan aileler",
      "Öğrencilerinin gelişimini desteklemek isteyen öğretmen ve kurumlar"
    ],
    contentItems: [
      "Dikkat ve hafıza oyunları",
      "Bireyin potansiyelini ortaya çıkarmaya yönelik uygulamalı teknikler",
      "Okuma–anlama ve hızlı öğrenme etkinlikleri",
      "Problem çözme ve mantıksal düşünme egzersizleri",
      "Özgüven geliştirme ve iletişim becerileri çalışmaları",
      "Ritim, hareket ve sanat temelli uygulamalar"
    ],
    schedule: "Haftada 1 gün 1 saat",
    location: "Sev-ay Eğitim ve Kariyer Danışmanlık Merkezi Atölye Salonu",
    instructor: "Çocuk gelişimi ve yaratıcı öğrenme alanında uzman eğitmenlerimiz, her çocuğun bireysel farklılıklarına uygun etkinliklerle gelişim sürecine destek olmaktadır.",
    feeInfo: "Ücret bilgisi için arayınız.",
    contactPhone: "0545 136 21 22",
    contactWhatsapp: "0544 470 14 55",
    extraNotes: [
      "Atölye sonunda gelişim raporu sunulur.",
      "Katılım kontenjanı sınırlıdır.",
      "✨ Çocuğunuzun eğitim yolculuğunu daha güçlü adımlarla desteklemek için siz de katılın!"
    ],
  },
]
